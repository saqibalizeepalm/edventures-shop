...
const GroupEdventureDetail = () => {
  return (
    <div>
      ...
      <div className="flex justify-between mt-5">
        <p className="text-2xl cursor-pointer">Anchor Colonies – Boston and <br/> Philadelphia</p>
      ...
      <div className="flex justify-between mt-5">
        <p className="text-2xl cursor-pointer">Belles of the Old South – New Orleans <br/> and Atlanta</p>
        <p className="font-bold text-lg">$1,500.00</p>
      </div>
      <div className="flex gap-6 mt-5">
        {/* <button
